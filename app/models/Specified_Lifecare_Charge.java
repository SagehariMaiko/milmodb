...
@Entity
@Table(name="specified_lifecare_charge")
public class Specified_Lifecare_Charge extends GenericModel {
	@Id
    ...
    public Specified_Lifecare_Charge(Map<String, String> mapdata, String formSerCd)  throws SQLException {    	
