...
@Entity
@Table(name="v_night_home_care")
public class V_night_home_care extends MilmoDBEntity {
	@Id
    ...
    public String zuijihoumon_service;
    public String hour_tuho;
    ...
    public void updateData(Map<String, String> mapdata) throws SQLException {
		...
		this.operationcenter = mapdata.get(ColumnNames.OPERATIONCENTER);
		this.route_service = mapdata.get(ColumnNames.ROUTE_SERVICE);
		this.zuijihoumon_service = mapdata.get(ColumnNames.ZUIJIHOUMON_SERVICE);
		this.hour_tuho = mapdata.get(ColumnNames.HOUR_TUHO);
