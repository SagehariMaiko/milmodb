...
@Entity
@Table(name="v_home_care")
public class V_home_care extends MilmoDBEntity {
	@Id
    ...
    public String sub_tokuteijigyosyo_1;
    public String sub_tokuteijigyosyo_2;
    public String sub_tokuteijigyosyo_3;
    public String sub_kinkyujihoumon;
    public String seikatsukinoukoujyourenkei;
    public String carestaffkaizen_1;
    public String carestaffkaizen_2;
    public String carestaffkaizen_3;
    public String jyoukoukaijyo;
    ...
    public String url;
    /*public Date prc_date = new Date();
    public Date upd_date = new Date();
    public Date preupd_date = new Date();*/
    ...
    public void updateData(Map<String, String> mapdata) throws SQLException {
        ...
        this.sub_tokuteijigyosyo_1 = mapdata.get(ColumnNames.SUB_TOKUTEIJIGYOSYO_1);
        this.sub_tokuteijigyosyo_2 = mapdata.get(ColumnNames.SUB_TOKUTEIJIGYOSYO_2);
        this.sub_tokuteijigyosyo_3 = mapdata.get(ColumnNames.SUB_TOKUTEIJIGYOSYO_3);
        this.sub_kinkyujihoumon = mapdata.get(ColumnNames.SUB_KINKYUJIHOUMON);
        this.seikatsukinoukoujyourenkei = mapdata.get(ColumnNames.SEIKATSUKINOUKOUJYOURENKEI);
        ...
        this.jyoukoukaijyo = mapdata.get(ColumnNames.JYOUKOUKAIJYO);
