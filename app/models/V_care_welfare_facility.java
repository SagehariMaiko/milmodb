...
@Entity
@Table(name="v_care_welfare_facility")
public class V_care_welfare_facility extends MilmoDBEntity {
	@Id
    ...
    public void updateData(Map<String, String> mapdata) throws SQLException {
    	...
    	this.taisyogosoudan = mapdata.get(ColumnNames.TAISYOGOSOUDAN);
