...
@Entity
@Table(name="local_based_specified_light")
public class Local_Based_Specified_Light extends GenericModel {
	@Id
    ...
    public Local_Based_Specified_Light(Map<String, String> mapdata, String formSerCd)  throws SQLException {    	
