...
@Entity
@Table(name="local_based_welfare")
public class Local_Based_Welfare extends GenericModel {
	@Id
    ...
    public Local_Based_Welfare(Map<String, String> mapdata, String formSerCd)  throws SQLException {    	
    ...
    public void setData(Map<String, String> mapdata){
    	...
    	this.small_kyoten = CommonFunc.func_setBit(mapdata,ColumnNames.SMALL_KYOTEN);
