...
class KaigoKensakuSpider(CrawlSpider):
    settings = get_project_settings()
    name = "KaigoKensakuSpider"
    allowed_domains = ["kaigokensaku.jp"]
    def __init__(self):
        self.start_urls = getStartUrls(int(self.serviceType))
        self.path = ".\\scraper\\tableDefinitions\\"+self.serviceType+".csv"    
