...
@Entity
@Table(name="v_home_rehabilitation")
public class V_home_rehabilitation extends MilmoDBEntity {
	@Id
	...
	public String houmonkangorenkei;
    ...
    public void updateData(Map<String, String> mapdata) throws SQLException {
		...
		this.houmonkangorenkei = mapdata.get(ColumnNames.HOUMONKANGORENKEI);
