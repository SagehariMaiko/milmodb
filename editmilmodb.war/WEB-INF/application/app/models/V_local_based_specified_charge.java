...
@Entity
@Table(name="v_local_based_specified_charge")
public class V_local_based_specified_charge extends MilmoDBEntity {
	@Id
    ...
    public String personal_distribution_2;
    public String personal_distribution_2_biko;
    public String indivudual_select;
    ...
    public void updateData(Map<String, String> mapdata) throws SQLException {
    	...
    	this.night_nursing = mapdata.get(ColumnNames.NIGHT_NURSING);
    	...
    	this.shortuse_local_specified = mapdata.get(ColumnNames.SHORTUSE_LOCAL_SPECIFIED);
    	...
    	this.personal_distribution_2 = mapdata.get(ColumnNames.PERSONAL_DISTRIBUTION_2);
    	this.personal_distribution_2_biko = mapdata.get(ColumnNames.PERSONAL_DISTRIBUTION_2_BIKO);
    	this.indivudual_select = mapdata.get(ColumnNames.INDIVUDUAL_SELECT);
