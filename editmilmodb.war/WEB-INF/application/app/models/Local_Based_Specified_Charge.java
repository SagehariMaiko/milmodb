...
@Entity
@Table(name="local_based_specified_charge")
public class Local_Based_Specified_Charge extends GenericModel {
	@Id
	public Long office_id;
	public Boolean private_kinou;
	public Boolean medicalkikanrenkei;
	public Boolean night_nursing;
	...
	public Boolean shortuse_local_specified;
	...
	public Boolean personal_distribution_2;
	public String personal_distribution_2_biko;
	public Boolean indivudual_select;
	public String indivudual_select_biko;
	...
	public Local_Based_Specified_Charge(Map<String, String> mapdata, String formSerCd)	throws SQLException {
	...
	public void setData(Map<String, String> mapdata){
		...
		this.night_nursing = CommonFunc.func_setBit(mapdata,ColumnNames.NIGHT_NURSING);
		...
		this.shortuse_local_specified = CommonFunc.func_setBit(mapdata,ColumnNames.SHORTUSE_LOCAL_SPECIFIED);
		...
		this.personal_distribution_2 = CommonFunc.func_setBit(mapdata,ColumnNames.PERSONAL_DISTRIBUTION_2);
		this.personal_distribution_2_biko = mapdata.get(ColumnNames.PERSONAL_DISTRIBUTION_2_BIKO);
		this.indivudual_select = CommonFunc.func_setBit(mapdata,ColumnNames.INDIVUDUAL_SELECT);
		this.indivudual_select_biko = mapdata.get(ColumnNames.INDIVUDUAL_SELECT_BIKO);
